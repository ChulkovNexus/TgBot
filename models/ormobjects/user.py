...
from sqlalchemy import Column, Integer, Sequence, String, ARRAY, ForeignKey
...
class User(Base):
    ...
    statuses = Column(Integer, ForeignKey('body_part_status.id'))
    dressed_items = Column(Integer, ForeignKey('items.id'))
    backpack = Column(Integer, ForeignKey('items.id'))
